...
\documentclass[1.5in,onehalf,11pt]{beavtex}
...
\section{In-line oscillating cylinder driven flow}
...
\begin{figure}[!htb]
	\centering
	\text{Drag over the first period, KC=5, Re=100}\par\medskip
	\begin{subfigure}{0.4\textwidth}
...
\begin{figure}[!htb]
	\centering
	\text{Drag over a steady state period, KC=5, Re=100}\par\medskip
	\begin{subfigure}{0.4\textwidth}
...
\begin{figure}[!htb]
	\centering
	\text{Drag over the 14th period, KC=10, Re=200}\par\medskip
	\begin{subfigure}{0.4\textwidth}
...
\begin{figure}[!htb]
	\centering
	\text{Drag vs time for an impulsively started oscillating cylinder}\par\medskip
...
Figure \ref{fig:viv_combine} shows the maximum amplitude of the six vortex-induced vibration simulations as calculated by external loose coupling, external strong coupling, embedded loose coupling and embedded strong coupling.
...
\begin{figure}
	\centering
	\text{Maximum amplitude vs reduced velocity for vortex-induced vibration}\par\medskip
	\includegraphics[width=\textwidth]{VIV_combine}
	\caption{Maximum cylinder amplitude in the lock-in region as computed with the external and embedded methods using loose and strong coupling.}
...
\section{Impulsively started cylinder flow error norms}
...
\begin{figure}[H]
	\centering
	\text{Error norms vs grid size for an impulsively started cylinder}\par\medskip
...
\begin{figure}[!htb]
	\centering
	\text{Average error vs uniform area grid spaceing for an impulsively started oscillating cylinder}\par\medskip
...
\begin{figure}[!htb]
	\centering
	\text{Run time vs grid size for an impulsively started cylinder}\par\medskip
...
\begin{figure}[!htb]
	\centering
	\text{Run time vs grid size for an impulsively started oscillating cylinder}\par\medskip
...
\begin{figure}[!htb]
	\centering
	\text{Run time vs uniform area grid spacing for an impulsively started oscillating cylinder}\par\medskip
