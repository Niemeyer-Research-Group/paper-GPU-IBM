...
\draw [black] (0,-2) circle (0pt) node[anchor=north] {$\Delta x$};                                      %dx label
\draw [lightgray, thin, dashed] (-1,-2) -- (1,-2);
\draw [lightgray, thin] (-1,-2) -- (-1,-2.25);
\draw [lightgray, thin] (1,-2) -- (1,-2.25);

\draw [black] (-2,0) circle (0pt) node[anchor=east] {$\Delta y$};                                       %dy label
\draw [lightgray, thin, dashed] (-2,1) -- (-2,-1);
\draw [lightgray, thin] (-1.75,1) -- (-2.25,1);
\draw [lightgray, thin] (-1.75,-1) -- (-2.25,-1);



\draw [black] (-2,-2) circle (0pt) node[anchor=north east] {Solid region};                                     %Solid label
\draw [black] (2,2) circle (0pt) node[anchor=south west] {Fluid region};                                       %Fluid label
